    ...
    return (
        ...
        >
            ...
            <img
                src="/img/1.png"
                alt="Decoration"
                className="absolute top-[-6vh] left-[-16vw] w-[30vw] max-w-[470px] xl:w-[470px] xl:max-w-[470px]"
            />
            <img
                src="/img/2.png"
                alt="Decoration"
                className="absolute top-[-27vh] right-[-5vw] w-[30vw] max-w-[410px] xl:w-[410px] xl:max-w-[410px]"
            />
            <img
                src="/img/center.png"
                alt="Decoration"
                className="absolute top-[-51vh] left-1/2 -translate-x-1/2 w-[40vw] max-w-[500px] xl:w-[500px] xl:max-w-[500px]"
            />
            <img
                src="/img/bottom-right.png"
                alt="Bottom Right"
                className="absolute bottom-[-20vh] right-[-20vw] w-[40vw] max-w-[500px] xl:w-[500px] xl:max-w-[500px] z-0"
            />
            <img
                src="/img/4.png"
                alt="Bottom Right Corner"
                className="absolute bottom-0 right-[-5vw] w-[15vw] max-w-[220px] xl:w-[220px] xl:max-w-[220px] z-20"
            />
            <img
                src="/img/5.png"
                alt="5"
                className="absolute bottom-[23vh] right-[2vw] w-[15vw] max-w-[200px] xl:w-[200px] xl:max-w-[200px] z-10"
            />
            ...
            <div className="w-full max-w-[1200px] flex flex-col lg:flex-row items-center justify-between z-10 gap-8 md:gap-12">
                ...
                <div className="w-full lg:w-1/2 flex justify-center lg:justify-start pt-24 lg:pt-0">
                    <motion.img
                        src="/img/main.png"
                        alt="Hero"
                        className="w-full max-w-[90%] sm:max-w-[400px] md:max-w-[500px] lg:max-w-[600px] xl:w-[700px] xl:max-w-[700px] h-auto object-contain"
