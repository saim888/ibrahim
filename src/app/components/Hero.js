    ...
    return (
        ...
        >
            ...
            <img
                src="/img/1.png"
                alt="Decoration"
                className="absolute top-[-6vh] left-[-10vw] w-[30vw] max-w-[470px] xl:w-[470px]"
            />
            <img
                src="/img/2.png"
                alt="Decoration"
            ...
            <div className="w-full max-w-[1200px] flex flex-col lg:flex-row items-center justify-between z-10 gap-8 md:gap-12 px-4">
